...
text(20,0.4,'forgetting-data MRE-HOT','FontName','Times New Roman','FontSize',ftsize)
...
text(20,0.4,'full-data MRE-HOT','FontName','Times New Roman','FontSize',ftsize)
legend('$\tilde\theta_1$','$\tilde\theta_2$','$\tilde\theta_3$','Interpreter','latex',...
    'NumColumns',1,'FontSize',ftsize,'box','off');
set(gca,'FontName','Times New Roman','FontSize',ftsize,'xtick',[]);
...
text(20,0.4,'discrete-data MRE-HOT','FontName','Times New Roman','FontSize',ftsize)
legend('$\tilde\theta_1$','$\tilde\theta_2$','$\tilde\theta_3$','Interpreter','latex',...
    'NumColumns',1,'FontSize',ftsize,'box','off');
set(gca,'FontName','Times New Roman','FontSize',ftsize,'xtick',[]);
...
axis([0,ylen,0,0.5]);box off 
ylabel('\boldmath$\tilde\theta$','Interpreter','latex','Position',[-5,0.25]);title('');
xlabel('Time (s)');text(-12,0.5,'(d)','FontName','Times New Roman','FontSize',ftsize);
text(20,0.4,'interval-data MRE-HOT','FontName','Times New Roman','FontSize',ftsize)
legend('$\tilde\theta_1$','$\tilde\theta_2$','$\tilde\theta_3$','Interpreter','latex',...
    'NumColumns',1,'FontSize',ftsize,'box','off');
set(gca,'FontName','Times New Roman','FontSize',ftsize);

print('fig/sim1_th_err.eps','-depsc');
...
axis([0,ylen,0,0.08]);yticks(0:0.04:0.08);box off 
xlabel('');
ylabel('$|e_1|$','Interpreter','latex','Position',[-8,0.04]);title('');
text(-12,0.08,'(a)','FontName','Times New Roman','FontSize',ftsize);
...
xlabel('Time (s)');ylabel('$\sigma_{\rm{c}}$','Interpreter','latex','Position',[-8,0.3]);title('');
text(-12,0.6,'(b)','FontName','Times New Roman','FontSize',ftsize);
legend('forgetting-data MRE-HOT','full-data MRE-HOT','discrete-data MRE-HOT','interval-data MRE-HOT',...
    'NumColumns',1,'FontSize',ftsize,'box','off');
set(gca,'FontName','Times New Roman','FontSize',ftsize);

print('fig/sim1_results.eps','-depsc');
